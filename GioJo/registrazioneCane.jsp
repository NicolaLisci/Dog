            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="registrazioneDogFriendly.jsp"> Inserimento DogFriendly</a>
                        </li>
                      
                        <li>
                            <a href="cambiaRuolo.jsp"> Cambio Ruolo</a>
                        </li>
                        <li>
...
<br>
<input style="margin-top:30px;" type="submit" name="registrati" id="registrati" class="btn btn-add" value="Registra"> 
