    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">MODIFICA CANE</h1>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                <!-- /.row -->
            ...
            <form class="form-horizontal" method="post" action="ModificaCaneServlet">
...
try 
{
	cane = daoCane.vediTutto(0); //da cambiare con il cane scelto
	//request.setAttribute("idCane", 61);
} catch (DAOException e) {
			e.printStackTrace();
		}%>
...
<div class="form-group">
  ...
  <div class="col-md-4">
  <input id="nome" name="nome" type="text" value="<%=cane.getNome()%>" class="form-control input-md" required="">
...
<div class="form-group">
  ...
  <div class="col-md-4">
  <input id="taglia" name="taglia" type="text" value="<%=cane.getTaglia()%>" class="form-control input-md" required="">
...
<div class="form-group">
  ...
  <div class="col-md-4">
    <select id="razza" name="razza" class="form-control" value="<%=cane.getIdRazza()%>">
...
<div class="col-md-4">
<input id="chip" name="chip" type="text" value="<%=cane.getChip()%>" class="form-control input-md" required="">
...
<div class="form-group">
  ...
  <div class="col-md-4">
  <input id="pelo" name="pelo" type="text" value="<%=cane.getPelo()%>" class="form-control input-md" required="">
...
<div class="form-group">
  ...
  <div class="col-md-4">
  <input id="nascita" name="nascita" type="date" value="<%=cane.getDataNascita()%>" class="form-control input-md" required="">
...
<form action = ModificaCaneServlet method= "POST" >
<input type="hidden" name = "idCane" value= <%cane.getIdCane(); %>/>
<div class="col-md-4 control-label">
<input type="submit" name="modifica" id="modifica" tabindex="4" class="btn btn-success"
value="Modifica">
</div>
