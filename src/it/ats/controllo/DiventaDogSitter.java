...
/**
 * Servlet implementation class DiventaDogSitter
 */
//@WebServlet("/DiventaDogSitter")
public class DiventaDogSitter extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public DiventaDogSitter() {
        super();
	    ...
	    try {
	      ...
	      try {
	       ...
	       //  System.out.println(utente.getUsername());
	         message.setText("L utente "+username+" desidera diventare DogSitter.\n"
