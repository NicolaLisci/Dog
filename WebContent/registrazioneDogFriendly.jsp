...
<body>
	...
	<form action="RegistrazioneDogFriendly" method="POST">
		...
		<input type="text" id="nomeAttivita" name="nomeAttivita"
			placeholder="nome Attività" class="form-control" /> 
			
            <br><h3>Indirizzo</h3>
            <br> 
            <input type="text" id="indirizzo" name="indirizzo" placeholder=indirizzo class="form-control" /> 
			<br><select name="idAttivita" placeholder="idAttivita" class="form-control" >
		...
		</select> <input type="submit" value="INVIA" class="form-control btn btn-register" />
	</form>
		</div>
						</div>
