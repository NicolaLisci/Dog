		...
		<div class="navbar-default sidebar" role="navigation">
			<div class="sidebar-nav navbar-collapse">
				<ul class="nav" id="side-menu">
					...
					<li><a href="#">I miei cani<span class="fa arrow"></span></a>
						<ul class="nav nav-second-level">
							...
							<li>
								...
								<form method="POST" action="PassaggioCane">
									...
									<input type="hidden" name="idCane" id="idCane"
										value="<%=cane.getIdCane()%>" />
									<button type="submit"
					...
					<li></li>
					<li><a href="#"></i>Gestione cani<span class="fa arrow"></span></a>
						<ul class="nav nav-second-level">
							<li><a href="panels-wells.html">Cerca</a></li>
							<li><a href="registrazioneCane.jsp">Aggiungi</a></li>

						</ul> <!-- /.nav-second-level --></li>
					<li><a href="#"></i>Dogsitter<span class="fa arrow"></span></a>
						<ul class="nav nav-second-level">
							<li><a href="VediDogSitter">Cerca</a></li>
							<li><a href="diventaDogSitter.jsp">Diventa Dogsitter</a></li>

						</ul></li>
					<li><a href="#">Toelettatura<span class="fa arrow"></span></a>
						<ul class="nav nav-second-level">
							<li><ahref="blank.html">Cerca</a></li>
							<li><a href="diventaToelettatore.jsp">Diventa
									Toelettatore</a></li>
						</ul> <!-- /.nav-second-level --></li>
				</ul>
			</div>
